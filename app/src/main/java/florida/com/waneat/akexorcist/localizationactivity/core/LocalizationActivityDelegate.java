package florida.com.waneat.akexorcist.localizationactivity.core;
...
import florida.com.waneat.Activities.CustomActivity;
...
public class LocalizationActivityDelegate {
    ...
    public void addOnLocaleChangedListener(LocalizationActivity onLocaleChangedListener) {
    ...
    public void addOnLocaleChangedListener(CustomActivity customActivity) {
    }
}
